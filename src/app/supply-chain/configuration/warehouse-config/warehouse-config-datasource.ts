...
export const EXAMPLE_WAREHOUSE_CONFIG_DATA: WarehouseConfigModel[] = [ 
 ...
 */
export class ScWarehouseConfigDataSource extends DataSource<WarehouseConfigModel> {
  data: WarehouseConfigModel[] = EXAMPLE_WAREHOUSE_CONFIG_DATA;
   ...
   */
  connect(): Observable<WarehouseConfigModel[]> {
   ...
   */
  private getPagedData(data: WarehouseConfigModel[]): WarehouseConfigModel[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: WarehouseConfigModel[]): WarehouseConfigModel[] {
