...
@Component({
  selector: 'app-bs-txn-details',
  templateUrl: './bs-txn-details.component.html',
  styleUrls: ['./bs-txn-details.component.css']
})
export class BsTxnDetailsComponent implements AfterViewInit {
